...
var formControlBinding = lang_1.CONST_EXPR(new di_1.Binding(control_directive_1.ControlDirective, { toAlias: di_1.FORWARD_REF(function () { return NgModelDirective; }) }));
var NgModelDirective = (function (_super) {
    ...
    NgModelDirective.prototype.viewToModelUpdate = function (newValue) { async_1.ObservableWrapper.callNext(this.ngModel, newValue); };
