...
const formControlBinding = CONST_EXPR(new Binding(ControlDirective, { toAlias: FORWARD_REF(() => FormControlDirective) }));
/**
 ...
 */
export let FormControlDirective = class extends ControlDirective {
    constructor() {
        super();
