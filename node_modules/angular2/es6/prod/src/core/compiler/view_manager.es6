...
import { ViewRef, internalView, internalProtoView } from './view_ref';
...
export let AppViewManager = class {
    constructor(viewPool, viewListener, utils, renderer) {
    ...
    createFreeHostView(parentComponentLocation, hostProtoViewRef, injector) {
        var hostProtoView = internalProtoView(hostProtoViewRef);
    ...
    destroyFreeHostView(parentComponentLocation, hostViewRef) {
        var hostView = internalView(hostViewRef);
    ...
    createFreeEmbeddedView(location, protoViewRef, injector = null) {
    ...
    destroyFreeEmbeddedView(location, viewRef) {
        var parentView = internalView(location.parentView);
        var boundElementIndex = location.boundElementIndex;
