...
import { ProtoRecord, RECORD_TYPE_PROPERTY, RECORD_TYPE_LOCAL, RECORD_TYPE_INVOKE_METHOD, RECORD_TYPE_CONST, RECORD_TYPE_INVOKE_CLOSURE, RECORD_TYPE_PRIMITIVE_OP, RECORD_TYPE_KEYED_ACCESS, RECORD_TYPE_PIPE, RECORD_TYPE_BINDING_PIPE, RECORD_TYPE_INTERPOLATE, RECORD_TYPE_SAFE_PROPERTY, RECORD_TYPE_SAFE_INVOKE_METHOD, RECORD_TYPE_DIRECTIVE_LIFECYCLE } from './proto_record';
...
export class JitProtoChangeDetector extends ProtoChangeDetector {
    ...
    instantiate(dispatcher) { return this._factory(dispatcher, this._pipeRegistry); }
