...
import { isPresent, isBlank, isType, BaseException } from 'angular2/src/facade/lang';
    ...
    recognize(url, parentComponent) {
        ...
        for (var i = 0; i < possibleMatches.length; i++) {
            ...
            if (candidate.unmatchedUrl.length == 0) {
                ...
                // children
                var children = StringMapWrapper.create(), allChildrenMatch = true, components = StringMapWrapper.get(candidate.handler, 'components');
